...
<div class="container-fluid h-100 mb-5 pb-5" id="divChat">
	<div class="row mb-5">
			...
			<div class="card-footer">
				<div class="input-group">
					...
					<div class="input-group-append">
						<span class="input-group-text send_btn"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></span>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="col-md-3 offset-md-1 text-center pt-5">
		<h3>Start your conversation with the Editor for any query</h3>
	</div>
	</div>
