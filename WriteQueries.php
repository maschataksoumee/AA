...
<html>
	...
	<!--Annimetion Class-->
	<script src="src/js/CustomScripts/writeQueries.js"></script>
		...
		<div class="container-fluid">
			...
			<div class="row" style="margin-top:20px;">
				...
				<div class="col-md-4">
					<div class="input-group form-control-border">
						...
						<input type="text" class="form-control" placeholder="Mail Id" id="txtMailId">
					</div>
				</div>
				<div class="col-md-4">
					<div class="input-group form-control-border">
						...
						<input type="text" class="form-control" placeholder="Project Code" id="txtProjectCode">
					</div>
				</div>
				<div class="col-sm-2 col-md-2 col-lg-2"></div>
			</div>
			...
			<div class="row" style="margin-top:40px;">
				...
				<div class="col-sm-2 col-md-2 col-lg-2">
					<button class="btn btn-primary px-4 m-1 btn-pill" onClick="btnPricingEnquirySubmit()">Submit</button>
				</div>
				<div class="col-sm-5 col-md-5 col-lg-5"></div>
			</div>
